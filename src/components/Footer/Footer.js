        ...
        <div className='cont-div'>
          ...
          <div className='copy-cont'>
            ...
            <li style={{ color: 'black' }}>
              <a href='https://wa.me/9822465339' style={{ color: 'black' }}>
                Whatsapp
              </a>
            </li>
            {/* 9822465339<br/> */}
            ...
            <li style={{ color: 'black' }}>
              <a href='tel:9822465339' style={{ color: 'black' }}>
                Call{' '}
              </a>
            </li>
            <li style={{ color: 'black' }}>
              <a href='tel:9822820339' style={{ color: 'black' }}>
                Another Call{' '}
              </a>
            </li>
            ...
            <li style={{ color: 'black' }}>
              <a
                href='mailto:artoflivingsewa@gmail.com?subject=Test email, please change this'
                style={{ color: 'black' }}
              >
                E-mail
              </a>
            ...
            <li style={{ color: 'black' }}>
              <a
                href='mailto:aolshwetalakhe@gmail.com?subject=Test email, please change this'
                style={{ color: 'black' }}
              >
                E-mail2
              </a>
            ...
            <li style={{ color: 'black' }}>
              <a
                href='https://www.facebook.com/Online-YOGA-100289865086171'
                style={{ color: 'black' }}
              >
                FacebookPage
              </a>
